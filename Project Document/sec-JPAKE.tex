...
We are now ready to describe the protocol. Let $G$ be a subgroup of $\mathbb{Z}_p^* = \mathbb{Z}_p \setminus \{0\}$ 
with prime order $q$, $g$ be a generator of the subgroup, and $\pi \in \mathbb{Z}_q^*$ be the shared password between Alice and Bob.
